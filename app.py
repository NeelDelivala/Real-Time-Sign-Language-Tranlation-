...
@app.route("/audio")
def audio():
    if hasattr(body, 'cap') and body.cap is not None:
        try:
            body.cap.release()
        except Exception as e:
            print("Error releasing camera in /audio:", e)
    return render_template('audio_out.html')

# Hardcoded user data (for testing)
HARDCODED_USERS = {
    "nd2160@srmist.edu.in": {
        "username": "Neel",
        "password": "Andy2408",
        "disability": "Normal",
        "role": "Student",
